...
class Dic {
  ...
  static String get cr_dis_cfg =>
      Security.security_displayConfig; //displayConfig
  ...
  static String get cr_piurl =>
      Security.security_personalImageurl; //personalImageurl
  ...
  static String get cr_cusri =>
      Security.security_customRoleInfo; //customRoleInfo
  static String get cr_posinf => Security.security_positionInfo; //positionInfo
  static String get cr_defval2 =>
      Security.security_defaultValueV2; //defaultValueV2
  static String get cr_img_prp =>
      Copywriting.security_image_Prompt; //Image Prompt
  static String get cr_synopsis => Security.security_Scenario; //Scenario
  static String get cr_dl_sl =>
      Copywriting.security_dialogue_Style; //Dialogue Style

  // API 接口（每个单词插入不同混淆词）
  static String get cr_fod => Security.security_queryOcDraft; // queryOcDraft
  static String get cr_fpd =>
      Security.security_queryPhysiqueDetails; // queryPhysiqueDetails
  ...
  static String get cr_ask_gen_rsp =>
      Security.security_requestGenResult; // requestGenResult
  ...
  static String get rcg_coiBalns =>
      Copywriting.security_coin_balance; // Coin balance
  static String get rcg_gmBalns =>
      Copywriting.security_gem_balance; // Gem balance
  ...
  static String get rcg_fuAces =>
      Copywriting.security_get_full_access_; // Get full access!
  ...
  static String get rcg_chnlInfo =>
      Security.security_channelInfo; // channelInfo
  static String get rcg_adrCnnl => '2'; // 2
  static String get rcg_iosChnnl => '3'; // 3
  static String get rcg_inapId =>
      Security.security_inAppProductId; // inAppProductId
  ...
  // Arhs
  static String get rcg_rcgItm =>
      Security.security_rechargeItem; // rechargeItem
  ...
  static String get rcg_ppt =>
      Security.security_premiumPeriodType; // premiumPeriodType
  ...
  // Apis
  static String get rcg_apiGPV2 =>
      Security.security_getPremiumInfoV2; // getPremiumInfoV2
  ...
  static String get rcg_trms =>
      Copywriting.security_terms_of_Service; // Terms of Service
  static String get rcg_privacy =>
      Copywriting.security_privacy_Policy; // Privacy Policy

  // Error Messages
  static String get rcg_errLoData =>
      Copywriting
          .security_failed_to_load_subscription_data; // Failed to load subscription data
  static String get rcg_errSeleProd =>
      Copywriting
          .security_please_select_a_product_to_recharge_; // Please select a product to recharge.
  static String get rcg_prchasDon =>
      Copywriting.security_purchase_done; // Purchase done
  static String get rcg_errSrvic =>
      Copywriting
          .security_unable_to_get_recharge_service__please_retry_later_; // Unable to get recharge service, please retry later.
  static String get rcg_errPlafm =>
      Copywriting.security_platform_not_supported_; // Platform not supported.
  static String get rcg_errRcg =>
      Copywriting.security_recharge_failed_; // Recharge failed.
  ...
  static String get rcg_iapWekly =>
      'com.lumina.pro_weekly'; // com.lumina.pro_weekly
  static String get rcg_iapMthly =>
      'com.lumina.pro_monthly'; // com.lumina.pro_monthly
  static String get rcg_iapYrly =>
      'com.lumina.pro_yearly'; // com.lumina.pro_yearly

  static List get rcg_coiProds => [
    {
      Security.security_id: 'com.lumina.coin_9.99',
      Security.security_price: '\$9.99',
      Security.security_value: 1000,
    },
    {
      Security.security_id: 'com.lumina.coin_29.99',
      Security.security_price: '\$29.99',
      Security.security_value: 3000,
    },
    {
      Security.security_id: 'com.lumina.coin_99.99',
      Security.security_price: '\$99.99',
      Security.security_value: 10000,
    },
  ];

  static List get rcg_gmProds => [
    {
      Security.security_id: 'com.lumina.gem_9.99',
      Security.security_price: '\$9.99',
      Security.security_value: 80,
    },
    {
      Security.security_id: 'com.lumina.gem_29.99',
      Security.security_price: '\$29.99',
      Security.security_value: 240,
    },
    {
      Security.security_id: 'com.lumina.gem_99.99',
      Security.security_price: '\$99.99',
      Security.security_value: 800,
    },
  ];
  ...
  static String rcg_geRcgBalns(int rcgType) =>
      rcgType == 0 ? rcg_coiBalns : rcg_gmBalns;
}
